...
// a hgt file is a special kind of topographical file 
// that stores, you guessed it, heights
String FILE = "../../data/N47W123.hgt";

// this is the size of our file, we just know what it is
int W = 1201;
int H = 1201;
...
void keyPressed()
{
  if(key == 'r')
  {
    HET_Export.saveToOBJ(mesh, "/Users/jnoble/code/Processing/export", "N47W123");
  }
}